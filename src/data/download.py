...
Usage:
    ...
    python src/data/download.py --skip-ebnerd-large
...
def download_mind(dest_dir: Path = MIND_DIR) -> None:
    """
    Download MIND-small using the Kaggle API and
...
def main():
    ...
    if not args.skip_ebnerd:
        download_ebnerd(
            include_small=not args.skip_ebnerd_small,
            include_large=not args.skip_ebnerd_large,
